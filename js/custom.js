...
$(function() {
  ...
  $('document').ready(function () {
      ...
      // Adicionando o nome "ADM _ UEMASUL" no lugar do temporizador
      var text = "ADM _ UEMASUL";
      $('#yourElementId').text(text); // Substitua "yourElementId" pelo ID real do elemento onde deseja exibir o nome.
